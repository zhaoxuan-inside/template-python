...
from app.application.dtos.example_dtos import (
    ExampleCreateDTO,
    ExampleResponseDTO,
    ExampleUpdateDTO,
)
...
from app.application.use_cases.example_use_cases import ExampleUseCases
from app.domain.exceptions.example_exceptions import (
...
async def get_example_use_cases(db: Annotated[AsyncSession, Depends(get_db)]) -> tuple[ExampleUseCases, AsyncSession]:
